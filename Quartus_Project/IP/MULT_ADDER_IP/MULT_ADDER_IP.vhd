...
entity MULT_ADDER_IP is
	port (
		result  : out std_logic_vector(63 downto 0);                    --  result.result
		dataa_0 : in  std_logic_vector(15 downto 0) := (others => '0'); -- dataa_0.dataa_0
		dataa_1 : in  std_logic_vector(15 downto 0) := (others => '0'); -- dataa_1.dataa_1
		dataa_2 : in  std_logic_vector(15 downto 0) := (others => '0'); -- dataa_2.dataa_2
		dataa_3 : in  std_logic_vector(15 downto 0) := (others => '0'); -- dataa_3.dataa_3
		datab_0 : in  std_logic_vector(15 downto 0) := (others => '0'); -- datab_0.datab_0
		datab_1 : in  std_logic_vector(15 downto 0) := (others => '0'); -- datab_1.datab_1
		datab_2 : in  std_logic_vector(15 downto 0) := (others => '0'); -- datab_2.datab_2
		datab_3 : in  std_logic_vector(15 downto 0) := (others => '0'); -- datab_3.datab_3
		clock0  : in  std_logic                     := '0';             --  clock0.clock0
		ena0    : in  std_logic                     := '0';             --    ena0.ena0
		aclr0   : in  std_logic                     := '0'              --   aclr0.aclr0
	);
end entity MULT_ADDER_IP;

architecture rtl of MULT_ADDER_IP is
	component MULT_ADDER_IP_0002 is
		port (
			...
			datab_2 : in  std_logic_vector(15 downto 0) := (others => 'X'); -- datab_2
			datab_3 : in  std_logic_vector(15 downto 0) := (others => 'X'); -- datab_3
			clock0  : in  std_logic                     := 'X';             -- clock0
			ena0    : in  std_logic                     := 'X';             -- ena0
			aclr0   : in  std_logic                     := 'X'              -- aclr0
		);
	end component MULT_ADDER_IP_0002;

begin

	mult_adder_ip_inst : component MULT_ADDER_IP_0002
		port map (
...
end architecture rtl; -- of MULT_ADDER_IP
...
-- IPFS_FILES : MULT_ADDER_IP.vho
-- RELATED_FILES: MULT_ADDER_IP.vhd, MULT_ADDER_IP_0002.v
